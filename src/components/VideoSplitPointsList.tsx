...
import { SplitPoint } from "./VideoEditor";
import { useState } from "react";

interface VideoSplitPointsListProps {
...
export const VideoSplitPointsList = ({
  splitPoints,
  onRemoveSplitPoint,
  onAddSplitPoint,
  onDownloadSegment,
    ...
    <Card className="bg-gradient-card border-border/50 shadow-card p-6">
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">Split Punten & Segmenten</h3>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="text-sm font-medium text-muted-foreground mb-3">
                Video Segmenten ({segments.length})
              </h4>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          ...
                          {isDownloadingSegment ? 'Verwerken...' : 'Download MP4'}
                        </Button>
                        <Button
                          size="sm"
                          variant="destructive"
        ...
        {splitPoints.length === 0 && (
          <div className="space-y-4">
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p>Nog geen split punten ingesteld</p>
              <p className="text-sm">Klik op de timeline of gebruik de tijdinvoer hierboven</p>
            </div>
          </div>
        )}
      </div>
